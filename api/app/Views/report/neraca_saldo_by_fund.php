<div class="pt-5 pl-20 pr-20 font-11">
    ...
    <table class="ml-20 mt-20 pl-10 line-1" style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            <th class="left-bordered right-bordered top-bordered text-left pl-10 pt-5 pb-5" colspan="4">Pemasukan</th>
        </tr>
        <?php $index = 1;
        ...
        <tr>
            ...
            <td class="pt-5 pb-5 pl-5 top-bordered border-top-2">Rp</td>
            <th class="bottom-bordered top-bordered right-bordered text-right pt-5 pb-5 pr-5 border-top-2"><?= $sumMutationsIn ?></th>
        </tr>
        <tr class="mt-10">
            <th class="left-bordered right-bordered top-bordered text-left pl-10 pt-5 pb-5" colspan="4">Pengeluaran</th>
        </tr>
        <?php $index = 1;
        ...
        <tr>
            ...
            <td class="pt-5 pb-5 pl-5 top-bordered border-top-2">Rp</td>
            <th class="bottom-bordered top-bordered right-bordered text-right pt-5 pb-5 pr-5 border-top-2"><?= $sumMutationsOut ?></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="pt-5 pb-5 pl-5 top-bordered bottom-bordered border-top-2">Rp</td>
            <th class="bottom-bordered top-bordered right-bordered text-right pt-5 pb-5 pr-5 border-top-2"><?= $totalEndBalance ?></th>
        </tr>
    </table>
</div>